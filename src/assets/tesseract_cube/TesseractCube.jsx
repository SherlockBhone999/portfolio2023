...
Command: npx gltfjsx@6.1.4 tesseractCube.gltf --transform
...
export function TesseractCube(props) {
  const { nodes, materials } = useGLTF('/tesseractCube-transformed.glb')
  return (
...
useGLTF.preload('/tesseractCube-transformed.glb')
